...
- **AND FIVE THINGS LATER SESSIONS ADDED THAT ONLY A RENDER CAN JUDGE**, each
  ...
  - **Seven trusses over the Great Hall** (#527). Whether
    ...
    which never reached Vespers (#636 to #638): a continuous slate ceiling,
    no gap to the sky.
  ...
  - ~~A luma read off the Great Hall's floor~~, for the covering row's OPEN
    ...
    reading the COVERED floor directly instead (69.8 to 89.8 of 255, #636 to
    #638) rather than comparing it against an open-sky number this run never
    produced.
...
`npm run play` to reach it (#636 to #638).
