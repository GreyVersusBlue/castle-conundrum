...
| `npm run bodies:render` | Writes Sweep, Stir, Hammer, Spar and Drill into the four human bodies from `tools/bodies/clips.json`. Hand-run, deterministic, a second run is a no-op (#787, #790). |
