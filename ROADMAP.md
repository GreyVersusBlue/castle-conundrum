...
NOW, in parallel, no gates:
  ...
  R6 five more, to 32 of 32, and a talk rail, shipped 2026-09-20 (#725-729).
                       |
...
| **R6** Life: a populace | Opus 5 | Container | C, D | ~~The file, the validator and the first ten~~ shipped 2026-09-17 (#616 to #618): a routine is a ring per bell, nine activities on three clips the kit already had, no asset added. ~~Five more people, a `talk` rail~~ shipped 2026-09-20 (#725 to #729): the page now builds 32 of 32 bodies, exactly `MAX_SKINNED_TOTAL` (#609), outer ward peaking at 18 of 20 and inner at 15 of 20, plus a flat `talk` list of three pairs played through the `#caption` band. What is left is the rest of the fifty (R9's town), the four activities still without a clip (R10), and the twelve's 27-pair chatter pool, still unspent by proximity. |
