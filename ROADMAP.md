...
Never gated, take whenever the lane is free:
  ...
  R3  the retro castle: increment 1 shipped, in a container (#754-763)
...
**R3's first increment shipped on 2026-09-21** (#754 to #763): the fifteen
...
before it. **Lane B is free again**; R9 can take it. What gates R3's second
