...
Never gated, take whenever the lane is free:
  ...
  R12c the dialogue format shipped 2026-09-18 (#659 to #662) and rank 12 is
  retired whole.
```
...
`npm run dialogue:compile` instead (#659 to #662).
