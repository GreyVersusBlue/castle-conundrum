...
yard (#706). **The town's first increment is specced and decided (#725 to
...
out of the count; and what they draw held against both wards' ceiling. The
next increment is a `builder` job.
